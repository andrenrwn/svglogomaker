...
export class Square extends Rectangle {
    constructor({ x = 70, y = 20, width = 160, round = 3, stroke, fill = "transparent", stroke_width = 5 } = {}) {
...
export class Ellipse extends Shape {
    constructor({ cx = 150, cy = 100, rx = 130, ry = 80, stroke, fill, stroke_width } = {}) {
        super({ stroke, fill, stroke_width });
        this.name = 'ellipse';
        this.cx = cx;
        this.cy = cy;
...
export class Circle extends Shape {
    constructor({ cx = 150, cy = 100, radius = 80, stroke, fill, stroke_width } = {}) {
        super({ stroke, fill, stroke_width });
        this.name = 'circle';
        this.cx = cx;
        this.cy = cy;
...
export class Triangle extends Circle {
    constructor({ cx = 150, cy = 100, radius = 85, stroke, fill, stroke_width } = {}) {
...
export class Polygon extends Circle {
    constructor({ cx = 150, cy = 100, radius = 85, sides = 5, stroke, fill, stroke_width } = {}) {
        super({ cx, cy, radius, stroke, fill, stroke_width });
        this.names = [
            'null',
            'monogon',
